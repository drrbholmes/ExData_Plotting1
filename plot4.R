...
#Reads in data from file then subsets data for specified dates Peng RP 
...
# Making a POSIXct date capable of being filtered and graphed by time of day Peng RP chapter 9
...
# Plot 4
plot(power_DT[, dateTime], power_DT[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
